      ...
      <Flex flexDirection="column" p="10" gap="4">
        ...
        <Flex gap="2">
          {random === 1 ? (
            <>
              <Flex
                onClick={() =>
                  window.open('https://trade.polynomial.finance/', '_blank')
                }
                cursor="pointer"
                w="48vw"
                h="270px"
              ...
              <Flex
                onClick={() =>
                  window.open(
                    'https://v3-perps.kwenta.io/market/?asset=sETH&accountType=cross_margin',
                    '_blank'
                  )
                }
                cursor={'pointer'}
              ...
              >
                ...
                <Text color="gray.500">
                  Trade crypto, forex, and commodities with up to 50x leverage
                  and deep liquidity.
                </Text>
              </Flex>
            </>
        ...
        <Flex flexDir="column" my="16" gap="4">
          ...
          <Text display={'flex'} fontWeight={'bold'}>
            7.&nbsp;
            <Text color="gray.500" fontWeight={'bold'}>
              Trading should be done through integrator front ends or directly
              through contracts
            </Text>
          </Text>
        </Flex>
        ...
        >
          ...
          <Flex flexDirection="column" p="4">
            ...
            <Text>
              ...
              program applies, with a discount of 90%. For frontends, discuss
              with respective integrator. For keepers, there are no bounties.
            </Text>
          </Flex>
        </Flex>
      </Flex>
